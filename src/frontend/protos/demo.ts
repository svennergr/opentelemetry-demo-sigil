  ...
  fromJSON(object: any): ListRecommendationsRequest {
    return {
      ...
      productIds: globalThis.Array.isArray(object?.productIds)
        ...
        ? object.product_ids.map((e: any) => globalThis.String(e))
        : [],
    };
  },
...
export const Product: MessageFns<Product> = {
  ...
  fromJSON(object: any): Product {
    return {
      ...
      priceUsd: isSet(object.priceUsd)
        ? Money.fromJSON(object.priceUsd)
        : isSet(object.price_usd)
        ? Money.fromJSON(object.price_usd)
        : undefined,
  ...
  fromJSON(object: any): GetProductReviewsResponse {
    return {
      productReviews: globalThis.Array.isArray(object?.productReviews)
        ...
        : globalThis.Array.isArray(object?.product_reviews)
        ? object.product_reviews.map((e: any) => ProductReview.fromJSON(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): GetAverageProductReviewScoreResponse {
    return {
      averageScore: isSet(object.averageScore)
        ? globalThis.String(object.averageScore)
        : isSet(object.average_score)
        ? globalThis.String(object.average_score)
        : "",
    };
  },
  ...
  fromJSON(object: any): GetQuoteResponse {
    return {
      costUsd: isSet(object.costUsd)
        ? Money.fromJSON(object.costUsd)
        : isSet(object.cost_usd)
        ? Money.fromJSON(object.cost_usd)
        : undefined,
    };
  },
...
export const Address: MessageFns<Address> = {
  ...
  fromJSON(object: any): Address {
    return {
      streetAddress: isSet(object.streetAddress)
        ? globalThis.String(object.streetAddress)
        : isSet(object.street_address)
        ? globalThis.String(object.street_address)
        : "",
  ...
  fromJSON(object: any): GetSupportedCurrenciesResponse {
    return {
      currencyCodes: globalThis.Array.isArray(object?.currencyCodes)
        ...
        : globalThis.Array.isArray(object?.currency_codes)
        ? object.currency_codes.map((e: any) => globalThis.String(e))
        : [],
    };
  },
...
export const CreditCardInfo: MessageFns<CreditCardInfo> = {
  ...
  fromJSON(object: any): CreditCardInfo {
    return {
      creditCardNumber: isSet(object.creditCardNumber)
        ? globalThis.String(object.creditCardNumber)
        : isSet(object.credit_card_number)
        ? globalThis.String(object.credit_card_number)
        : "",
      creditCardCvv: isSet(object.creditCardCvv)
        ? globalThis.Number(object.creditCardCvv)
        : isSet(object.credit_card_cvv)
        ? globalThis.Number(object.credit_card_cvv)
        : 0,
      creditCardExpirationYear: isSet(object.creditCardExpirationYear)
        ? globalThis.Number(object.creditCardExpirationYear)
        : isSet(object.credit_card_expiration_year)
        ? globalThis.Number(object.credit_card_expiration_year)
        : 0,
      creditCardExpirationMonth: isSet(object.creditCardExpirationMonth)
        ? globalThis.Number(object.creditCardExpirationMonth)
        : isSet(object.credit_card_expiration_month)
        ? globalThis.Number(object.credit_card_expiration_month)
        : 0,
    };
  },
  ...
  fromJSON(object: any): ChargeRequest {
    return {
      ...
      creditCard: isSet(object.creditCard)
        ...
        ? CreditCardInfo.fromJSON(object.credit_card)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): OrderResult {
    return {
      ...
      shippingTrackingId: isSet(object.shippingTrackingId)
        ...
        : "",
      shippingCost: isSet(object.shippingCost)
        ? Money.fromJSON(object.shippingCost)
        : isSet(object.shipping_cost)
        ? Money.fromJSON(object.shipping_cost)
        : undefined,
  ...
  fromJSON(object: any): PlaceOrderRequest {
    return {
      userId: isSet(object.userId)
        ...
        ? globalThis.String(object.user_id)
        : "",
      userCurrency: isSet(object.userCurrency)
        ? globalThis.String(object.userCurrency)
        : isSet(object.user_currency)
  ...
  fromJSON(object: any): AdRequest {
    return {
      contextKeys: globalThis.Array.isArray(object?.contextKeys)
        ...
        : globalThis.Array.isArray(object?.context_keys)
        ? object.context_keys.map((e: any) => globalThis.String(e))
        : [],
    };
  },
